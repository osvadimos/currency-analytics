...
class TestCurrencyService(TestCase):
    ...
    def test_pull_price_history(self):
        ...
        markets = market_manager.list_markets()
        currency_service = CurrencyService()
        market_pair = MarketPair(markets[0], markets[2])
        currency_service.pull_price_history(market_pair)

    def test_depth(self):
        currency_service = CurrencyService()
        result = currency_service.pull_depth("Oil Brent")
        result
